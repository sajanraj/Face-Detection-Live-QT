...
# Form implementation generated from reading ui file 'facedtwork(live).ui'
#
...
class Ui_Facedetection(object):
    ...
    def setupUi(self, Facedetection):
        ...
        self.horizontalLayout_2.addWidget(self.golivebtn)
        self.gridLayout_3.addLayout(self.horizontalLayout_2, 1, 4, 1, 1)
        ...
        self.gridLayout_3.addLayout(self.scanLayout_2, 1, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.addprofileWidget, 1, 0, 1, 2)
    ...
    def update_frame(self):
        ...
        self.image = facecode.faceplot(self.image)
